...
class Profil extends CI_Controller
{
    ...
    public function desa()
    {
        ...
        $data['title'] = "Profil desa Randowabagirang";
    ...
    public function sejarah()
    {
        ...
        $data['title'] = "Sejarah desa Randowabagirang";
    ...
    public function pemdes()
    {
        ...
        $data['title'] = "Profil Pemerintah Desa Randobawagirang";
    ...
    public function bpd()
    {
        ...
        $data['title'] = "Profil Badan Permusyawaratan Desa Randobawagirang";

    ...
    <ul>
        ...
        <li class="link">
            ...
            <ul class="collapse collapseable" id="collapse-profil">
                ...
                <li><a href="<?= base_url('admin/profil/vm'); ?>">Visi Misi</a></li>
                <!-- <li><a href="<?= base_url('admin/profil/desa'); ?>">Potensi Desa</a></li> -->
                <!-- <li><a href="<?= base_url('admin/profil/desa'); ?>">Peta Wilayah</a></li> -->

        ...
        <div class="row">
            ...
            <div class="span4">
                <div class="widget">
                    ...
                    <address>
                        <strong>Kantor Desa randobawagirang</strong><br>
                        Jl. randobawagirang, Desa randobawagirang, Kecamatan Mandirancan ,<br>
                        Kabupaten Kuningan Provinsi Jawa Barat. Kode Pos kosong Indonesia
                    </address>
                    <p>
                        <i class="icon-phone"></i>0859619133321 <br>
                        <i class="icon-envelope-alt"></i> randobawagirangdesa@gmail.com
                    </p>
                </div>
            </div>
            <div class="span4">
    ...
    <div id="sub-footer">
        <div class="container">
            <div class="row">
                <div class="span6">
                    <div class="copyright">
                        <p><span>&copy; Copyright <?= date('Y'); ?>. Desa Randobawagirang</span></p>
                    </div>
                </div>
            </div>
        </div>

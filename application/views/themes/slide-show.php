...
<section id="featured">
    ...
    <div class="camera_wrap" id="camera-slide">
        ...
        <?php foreach ($news as $row) : ?>
            <div data-src="<?php echo base_url('public/'); ?>img/slides/camera/slide1/gunung.jpg">
                <div class="camera_caption fadeFromLeft">
                    <div class="container">
                        <div class="row">
                            <div class="span6">
                                <h2 class="animated fadeInDown"><strong>News Update <span class="colored">Potensi Desa</span></strong></h2>

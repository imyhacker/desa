<div id="content">
    ...
    <div class="content-inner">
        <div class="form-wrapper">
            <?php echo form_open_multipart('admin/potensidesa/tambah', array('method' => 'POST')); ?>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control summernote" placeholder="Potensi desa..." name="content"></textarea>
